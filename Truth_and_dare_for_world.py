...
#names=input(f"Input the names of players. please seperate the names with a coma(,) ")
#names=names.strip()
#names=names.title()
...
#        active=False
#    else:
#        print("You give me an input please")
#print(names)
...
#THIS ONE DOES NOT HAVE DEFUALT DARE AND TRUTH QUESTIONS
#import random as rd
#import numpy as np
